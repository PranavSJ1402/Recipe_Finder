...
const RecipeFinder = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 font-sans bg-white rounded-lg shadow-md">
      <h1 className="text-4xl font-bold text-center text-orange-600 mb-6">
        Find Recipe for your fav meals
      </h1>
      ...
      <div className="flex justify-center mb-6">
        <input
          ...
          className="w-64 p-3 text-lg border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <button
          onClick={fetchMeal}
          className="ml-4 py-3 px-6 bg-blue-600 text-white text-lg font-semibold rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          Search
        </button>
      </div>
        ...
        <div className="mt-6 bg-gray-50 p-6 rounded-lg shadow-lg">
          <div className="flex flex-col md:flex-row items-center">
            <img
              ...
              alt={meal.strMeal}
              className="w-80 h-80 object-cover rounded-lg shadow-md md:w-1/3 md:mr-6"
            />
